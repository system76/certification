...
| ------------- | -------------- | ------------ | ----------------------- |
|   COMPLETE    | Pop!\_OS 22.04 | 5.01         | Both                    |
...
- BIOS is requested with onboard DisplayPort disabled because if it is enabled it makes some discrete GPUs laggy
...
- This system will only suspend with 1, 2, or 4 RAM DIMMs populated
