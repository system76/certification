...
| ------------- | -------------- | ------------ | ---------- | ----------------------- |
| COMPLETE      | Pop!\_OS 22.04 | 2025-03-19_3148651 | 2025-03-19_3148651 | both      |
...
- [x] Left USB Type A
- [x] Right USB Type A
- [x] Right USB Type C (port 1)
- [x] Right USB Type C (port 2)
...
does not boot correctly with single ram dimm - does not show BIOS or any graphics on screen
