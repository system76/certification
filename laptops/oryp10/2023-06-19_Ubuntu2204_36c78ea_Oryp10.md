...
| ------------- | -------------- | ------------ | ---------- | ----------------------- |
| INCOMPLETE    |  UBUNTU 22.04  | 36c78ea      | 36c78ea    | Both                    |
...
- Ubuntu doesn't appear to have an option for two and three finger clicks. I feel like it used to after installing system76 packages?
