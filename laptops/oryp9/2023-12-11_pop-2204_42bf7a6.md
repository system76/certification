...
|---------------|----------------|---------------------|---------------------|-------------------------|
| COMPLETE      | Pop!\_OS 22.04 | 2023-09-08\_42bf7a6 | 2023-09-08\_42bf7a6 | Both                    |
...
- Only reaches C3 state, but that is deeper than currently released firmware (C2, due to card reader bug that was fixed previously)
