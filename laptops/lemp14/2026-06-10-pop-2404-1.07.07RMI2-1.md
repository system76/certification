...
|---------------|----------------|---------------|------------|
| INCOMPLETE    | Pop!\_OS 24.04 | 1.07.07RMI2-1 | 1.07.02MI2 |
...
- [x] Fan full speed/auto toggle

### Hot key notes and issues

- Mic mute hotkey doesn't work
- Suspend hotkey seems to be triggering a suspend event, but suspend is not working correctly.
...
- Suspend isn't working correctly. Screen dims, locks, and turns off, but power button light, keyboard backlight, and status indicator light stay lit solid. Current working theory is that BIOS and EC aren't communicating suspend events correctly between each other.
...
- RAM is soldered, so SODIMM testing is not necessary or possible.
