...
|---------------|----------------|--------------------|--------------------|-------------------------|
| INCOMPLETE    | Pop!\_OS 22.04 | 023-10-13\_5d997d1 | 023-10-13\_5d997d1 | Both                    |
...
- [x] Suspend
- [x] Play/Pause
- [x] Keyboard backlight toggle levels
- [x] Fan toggle

### Hot key notes and issues

- Keyboard backlight reporting bug is still present: https://github.com/system76/firmware-open/issues/458 (not a regression)
...
- Does not get lower than C2 power state, but this is not a regression.
