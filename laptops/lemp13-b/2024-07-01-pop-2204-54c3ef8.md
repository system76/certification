...
|---------------|----------------|---------------------|---------------------|-------------------------|
| COMPLETE      | Pop!\_OS 22.04 | 2024-07-01\_54c3ef8 | 2024-07-01\_54c3ef8 | Both                    |

* Note: this update was for the 5600 MT/s memory upgrade in lemp13-b.
Tests were performed mainly on the 5600 unit, but the previous 4800 lemp13-b was also tested with this update.
...
- [x] Suspend
- [x] Play/Pause
- [x] Keyboard backlight brightness toggle
...
- [x] Left USB Type A
- [x] Right USB Type A
- [x] Right rear USB Type C (non-TB)
- [x] Right front USB Type C (TB)
- [x] SD card slot
...
- Powertop reports C10 and C1E power states being reached.
...
- 4800 MT/s SODIMMs were also tested. Clock speeds reduce to 4800 as expected.
