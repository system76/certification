...
|---------------|----------------|---------------------|---------------------|-------------------------|
| COMPLETE      | Pop!\_OS 22.04 | 2023-05-22\_aa4a52b | 2023-05-22\_aa4a52b | Both                    |
...
- [x] Suspend
- [x] Play/Pause
- [x] Keyboard backlight level toggle
- [x] Fan toggle
...
- [ ] USB-C docking and charging on a 90W monitor is stable under stress

### Suspend notes and issues

- galp7 overdraws Viewsonic 27" monitor, rated at 90W, while stressing or building kernel
