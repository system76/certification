...
| ------------- | -------------- | ------------ | ---------- |
| COMPLETE      | Pop!\_OS 24.04 | 1.07.05      | 1.09.08MI1 |
...
no touchpad lock or airplane mode keys working
...
combo mic does not work even manually setting with pavucontrol
...
setting BIOS to dedicated GPU
  unplugging HDMI will also make internal display blank and wont suspend

no decryption dialogue on external display with lid closed

daisy chaining usb-c to display port with another display does not work.
