...
no system76-driver installed so airplane mode key and keyboard backlight keys not function atm
...
combo jack mic does not work
  probably needs system76-driver stuffs
...
BIOS > enable dgpu:
  ...
  USB-C out does not daisy chain.
