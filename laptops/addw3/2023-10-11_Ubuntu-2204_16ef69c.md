...
| ------------- | -------------- | ------------ | ---------- | ----------------------- |
|   COMPLETE    | Pop!\_OS 22.04 | 16ef69c      | 16ef69c    | Both                    |
...
- [x] Tap to click
    - [x] Left click
    - [x] Right (two finger) click
    - [x] Middle (three finger) click
...
- There is a non-regression issue when booting with an external monitor attached via mini-DP. Internal display gets stuck at the System76 splash screen until it is turned off and on again. When it is turned on again, gnome-shell crashes, killing the user session, and kicking the user back to login.
