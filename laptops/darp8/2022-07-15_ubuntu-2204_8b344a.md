...
| ------------- | -------------- | ------------ | ---------- | ----------------------- |
|   COMPLETE    | Ubuntu 22.04   | 8b8344a      | 123        | After                   |
...
- [na] Four finger swipe up or down changes workspaces
...
- [na] Reboot w/ lid closed. Decryption dialog shows on external display.
