...
|---------------|----------------|---------------------|---------------------|-------------------------|
| COMPLETE      | Pop!\_OS 22.04 |            42bf7a6  |             42bf7a6 | Both                    |
...
- While not a regression, the the system only seems to achieve C3. The prior release, at time of certification, could only achieve C2, and would not suspend at all.
