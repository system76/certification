...
| ------------- | -------------- | ------------ | ---------- | ----------------------- |
|   COMPLETE    | Pop!\_OS 22.04 | 8b8344a      | 123        | After                   |
...
- [x] Right USB Type A
- [x] Left USB Type A
- [x] Left USB Type C (USB 3.2)
- [x] Left USB Type C (TB and PD)
- [x] SD card slot
...
- Daisy chain over USB-C is not available. Likewise reboot w/ lid closed only shows decryption screen over HDMI not USB-C DP
...
- [x] Power on while unplugged & run stress command (also compiled firmware-open as well as kernel 5.15.5).
