...
| ------------- | -------------- | ------------ | ---------- | ----------------------- |
|   COMPLETE    | Pop!\_OS 22.04 | 6c492c3      | 6c492c3    | Both                    |
...
- The four finger paradigm does not work on Ubuntu at current. However, on Darp8, the stock Ubuntu three-finger paradigm does work at current.
...
- Due to an issue with the Realtek ethernet device in the Darp8, the system does not reach c-states below c3 in active use, though it does reach states as low as c10 during suspend.
