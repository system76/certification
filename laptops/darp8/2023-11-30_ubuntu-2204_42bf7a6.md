...
- Ubuntu continues to struggle with both four-finger and three-finger paradigms with pop packages included
...
- [x] Display toggle hotkey (Fn + F7) toggles external display modes
- [x] Super + P cycles external display modes

### Displays notes and issues

- USB-C needs an unplug/re-plug after a cold boot, but this is a known issue: https://github.com/system76/firmware-open/issues/343
...
-System achieves C3. At time of certification, released firmware achieves C2, making this an improvement.
...
- [x] Storage
    - [x] System boots and suspends/resumes with each of the following drive models (test each one in every possible slot):
        - [x] Samsung 960 Evo (PCIe Gen 3)
        - [x] Samsung 980 Pro (PCIe Gen 4)
        - [x] Western Digital Blue SN350 (PCIe Gen 3)
