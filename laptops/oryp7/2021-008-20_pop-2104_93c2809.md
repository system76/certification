...
- Had to plug in Type-C twice before it worked in Hybrid mode (not specific to oryp7, not a regression.)
- Decryption dialog doesn't show on external displays when rebooting with lid closed (not a regression.)
