...
| ------------- | -------------- | ------------ | ---------- |
| Complete      | Pop!\_OS 22.04 | XYZ          | 2024-07-08_926f73d |
...
external display with lid closed: after logging in for first time, system goes immediately to sleep.
pressing any key on external keyboard will wake system.
