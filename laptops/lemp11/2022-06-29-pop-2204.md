...
| ------------- | -------------- | ------------ | ---------- | ----------------------- |
| COMPLETE      | Pop!\_OS 22.04 | 5fad8b4      | 123        | After                   |
...
- Suspend issues with first boot
...
- Thunderbolt not discovered on boot until unplugged/replugged in.
...
- No display for the decrypt screen over USB-C DP with "Reboot w/ lid closed" however HDMI worked fine.
