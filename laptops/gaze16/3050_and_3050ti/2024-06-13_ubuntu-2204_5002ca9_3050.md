...
| ------------- | -------------- | ------------ | ---------- | ----------------------- |
|   COMPLETE    |  Ubuntu 22.04  | 5002c9a      | 5002c9a    |   Both                  |
...
- Ubuntu suppot for multi-touch swipe is inconsistent model to model. This is not a regression, nor blocking for this release.
...
- Issues with the gigabit lan nic prevent C-states below C-3 at current. This is not a regression.
