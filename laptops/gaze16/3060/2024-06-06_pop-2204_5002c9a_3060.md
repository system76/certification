...
| ------------- | -------------- | ------------ | ---------- | ----------------------- |
|   COMPLETE    | Pop!\_OS 22.04 | 5002c9a      | 5002c9a    | Both                    |
...
- [x] Type-C display port
- [x] Type-C display port audio
...
- Due to an ongoing issue with certain ethernet devices, C-states below C3 cannot be reached at current. This is not a regression.
