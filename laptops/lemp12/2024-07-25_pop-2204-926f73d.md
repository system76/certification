...
|---------------|----------------|---------------------|---------------------|-------------------------|
| INCOMPLETE    | Pop!\_OS 22.04 | 2024-07-08\_926f73d | 2024-07-08\_926f73d | Both                    |
...
- Only C2 power state is reached in powertop. Flashing previously released version shows the same behavior, so this is not a regression.
