...
| ------------- | -------------- | ------------------- | ------------------- | ----------------------- |
|   COMPLETE    | Ubuntu 20.04   | 2020-12-04\_0e80285 | 2020-12-04\_0e80285 | Before                  |

### Note: tested with Trubble image that we built today
...
- [x] Bottom right corner of clickpad = right click
...
- Fn + F7 locks the machine instead of changing display modes. In Pop, the hotkey just did nothing. Super+P still works fine for this functionality.
...
- [ ] System prompts and eventually suspends on depleted battery (tested in Pop 20.04)
