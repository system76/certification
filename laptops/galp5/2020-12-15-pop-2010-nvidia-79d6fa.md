...
| ------------- | -------------- | ------------ | ---------- | ----------------------- | ------------- |
| INCOMPLETE    | Pop!\_OS 20.10 | 79d6fa       | 79d6fa     | Both                    | Integrated    |
...
- Still seeing SD card reader fail to function after USB ports have been used.
...
- Skipped long-running tasks for now.
