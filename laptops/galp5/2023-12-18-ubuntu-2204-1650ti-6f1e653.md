...
| ------------- | -------------- | --------------- | ------------- | ----------------------- |
| COMPLETE      |  Ubuntu 22.04  |   6f1e653       |    6f1e653    | Both                    |
...
- Three and four finger gesture paradigms do not reliably work in Ubuntu with the various System76 packages installed.
