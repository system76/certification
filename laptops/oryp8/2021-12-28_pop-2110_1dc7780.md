...
- Internal mic not operational while S/PDIF jack is in use (not a regression).
...
- [X] HDMI + Mini-DP daisy-chain + internal display
- [X] Close internal display. Monitors adjust correctly.
- [X] Reboot w/ lid closed. Decryption dialog shows on external display.

### Displays notes and issues

- Decryption prompt showed on USB-C display outputs, not on HDMI or Mini DisplayPort.
