...
|---------------|----------------|---------------------|---------------------|-------------------------|
| INCOMPLETE    | Pop!\_OS 22.04 | 2024-03-19\_14aee2d | 2024-03-19\_14aee2d | Both                    |
...
- Changing RAM sticks directly makes system unbootable. Instead, I have to remove the old RAM stick, boot with only onboard RAM once, power back down, and then install the new stick.
