...
|---------------|----------------|---------------------|---------------------|-------------------------|
| COMPLETE      | Pop!\_OS 22.04 | 2023-08-18\_a8dd6c2 | 2023-08-18\_a8dd6c2 | Both                    |
...
- Keyboard backlight level reporting has same odd behavior as mentioned in https://github.com/system76/firmware/pull/522#issuecomment-1690364869
...
- USB-C display doesn't work on cold boot without unplug/re-plug. Known issue, affects more than just lemp9.
...
- Unit is only reaching C6, not C7 or C8. Behavior is identical on currently released firmware.
...
- [x] Storage
    ...
    - [x] System boots and suspends/resumes with each of the following drive models (test each one in every possible slot):
        ...
        - [x] SK Hynix 1tb drive (PCIe Gen 3)
