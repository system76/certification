...
- Only three displays total work at once, not a regression.
...
- WiFi card gave iwlwifi error during upload test; not a regression, this machine was giving WiFi errors with old firmware per Ben's logs.
