...
|---------------|--------------|---------------------|---------------------|
| INCOMPLETE    | Ubuntu 24.04 | 2025-07-24\_c242738 | 2025-07-24\_c242738 |
...
- Combo jack mic prompt quirk fix is present in 6.12 only. Imaged units will have 6.12, but this is notable because one of the tests I did was done with an Ubuntu 24.04 ISO that I fully upgraded before adding the system76-dev/pre-stable PPA and installing system76-driver-nvidia, which would pull in our version of 6.12 with the quirk fix.
...
- RAM and NVMe tests were run on Pop 22.04
