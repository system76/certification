...
|---------------|----------------|--------------------|------------|
| INCOMPLETE    | Pop!\_OS 22.04 | 1.07.04BIOS\_GUARD | 1.09.02    |
...
- Mic mute is acting as LCD toggle. Need modified EC. Request made.
- Keyboard backlight controls are not working. Need to add this to system76-acpi to make those work.
...
- 6400MHz CSODIMMs seem unsupported.
