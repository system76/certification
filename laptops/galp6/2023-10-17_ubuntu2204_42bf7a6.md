...
| ------------- | -------------- | ------------ | ---------- | ----------------------- |
|   COMPLETE    |  Ubtuntu 22.04 | 42bf7a6      | 42bf7a6    | Both                    |
...
- [x] Three finger swipe changes workspaces or brings up activities view.
...
- Failure to reach the C8 state is an ongoing and known issue.
