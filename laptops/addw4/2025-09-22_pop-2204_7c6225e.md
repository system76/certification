...
| ------------- | -------------- | ------------ | ---------- |
|   COMPLETE    | Pop!\_OS 22.04 | 7c6225e      | 7c6225e    |
...
- Hybrid & Nvidia Mode
  - Decrypt dialog does not show on external monitor when rebooted while lid is closed. (HDMI) (not a regression)
...
- [x] RAM
    ...
    - [x] CSODIMMs boot, suspend/resume, and run at full speed
- [x] Storage
    - [x] System boots and suspends/resumes with each of the following drive models (test each one in every possible slot):
        - [x] Samsung 970 Evo Plus (PCIe Gen 3)
        - [x] Samsung 980 Pro (PCIe Gen 4)
        - [x] Western Digital Blue SN570 (PCIe Gen 3)
        - [x] Crucial P510 (PCIe Gen 5)
