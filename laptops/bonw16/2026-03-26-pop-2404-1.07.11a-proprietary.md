...
| ------------- | -------------- | ------------ | ---------- |
|   COMPLETE    | Pop!\_OS 24.04 | 1.07.11a     | 1.07.03MI1 |
...
- No early graphics on external displays. (Not a regression)
- External display connected through HDMI, after reboot with external display closed, suspend hangs when suspending with external display closed. (Not a regression)
