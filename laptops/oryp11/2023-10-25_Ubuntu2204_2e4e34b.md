...
| ------------- | -------------- | ------------ | ---------- | ----------------------- |
| COMPLETE      |  UBUNTU 22.04  | 2e4e34b      | 2e4e34b    | Both                    |
...
-  Four finger swipe continues to not function under Ubuntu.
...
- On production units, a bug has been resolved where audio would cut out and in frequently when using internal speakers. This was no reproducable on the lab unit. Future reports of audio issues should keep in mind that production and test hardware have a known divergence.
