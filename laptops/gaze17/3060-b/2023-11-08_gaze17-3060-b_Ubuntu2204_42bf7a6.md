...
- As on many systems, the four-finger system76 Paradigm, does not work, nor does the default three-finger Gnome paradigm. This is not a regression.
...
- [x] Laptop reached at least a C8 power state after idling for ~10 minutes (in `powertop`, in the "Idle stats" tab, the `Pkg(HW)` column should have a C8 percentage >0%)
...
- [x] TPM
    ...
    - [x] No TPM errors in dmesg & journalctl logsafter 150 suspends
